...
<section class="content">
 <div class="col-sm-12" align="right">
            <a class="btn btn-rounded btn-danger" href="{{ url('admin/add-page') }}" onClick="click_button(1)"><i class="fas fa-edit"></i> New</a>
            <a class="btn btn-rounded btn-primary" href="javascript:void(0)" onClick="click_button(2)"><i class=" fa fa-search"></i> Search</a>  
            <a class="btn btn-rounded btn-warning" href="{{ url('admin/list-page') }}"><i class="ace-icon fa fa-sync-alt"></i> Reset</a>    
          </div>
		  <br>
 ...
 <div class="row" style="display: block;">
  <div class="col-md-12">
		...
		<div class="card-header"> 
			  ...
			  <div class="card-body">
                                    <form role="form" action="{{url('admin/list-page')}}" method="get" enctype="multipart/form-data" >
		             ...
		             $descr = base64_decode($val['description']);
				      ...
				      <tr>
                       ...
                       <td>{{  substr(strip_tags($descr),0,100)."..." }}</td>
                        <td>@if($val->image)
                        <img src="{{ url('public/uploads/small/'.$val->image) }}">
						    @endif
						 </td>
                          <td>{{ $val->page }}</td>
					  <td> <a href="{{ url('admin/edit-page?edit='.$val->id.'&page='.$page) }}" role="button" class="btn btn-sm btn btn-primary btncss" ><i class="fas fa-edit"></i></a>
						   <a href="{{ url('admin/delete-page?del='.$val->id.'&page='.$page) }}" onClick="return confirm('Do you want to delete this Page?')" role="button" class="btn btn-sm btn btn-danger btncss" ><i class="fas fa-trash-alt"></i></a>
					 </td>
                    </tr>
				   @endforeach
           			 @else
